...
OBJS = GameView.o Map.o Places.o Queue.o List.o
...
GameView.o : GameView.c Globals.h GameView.h List.h Map.h
HunterView.o : HunterView.c Globals.h HunterView.h Map.h
DracView.o : DracView.c Globals.h DracView.h List.h Map.h
